...
If you need to deploy any StorageGRID appliance Storage Nodes, see link:../installconfig/deploying-appliance-storage-node.html[Deploy appliance Storage Node].
